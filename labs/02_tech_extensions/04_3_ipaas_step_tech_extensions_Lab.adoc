...
. Using a new web browser, download the latest link:https://github.com/syndesisio/fuse-online-tp3-sample-extension/releases[*source code release*] for the `Damage Reporter` step extension, in .zip archive format.
...
|======
|*Name*|*Number*|*Company*
|Sha Borenstein|937 512 235|Westside Retailers
|Nandan Joshi|988 345 111|Finest Goods
|Bernard Tison|862 223 402|Eastside Specialty Outlets
|======
+
