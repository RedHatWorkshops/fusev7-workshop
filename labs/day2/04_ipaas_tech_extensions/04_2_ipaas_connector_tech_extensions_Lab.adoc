...
. Upload to your AWS S3 bucket, the link:https://github.com/gpe-mw-training/fuse-ipaas-labs/04_technical_extensions/coolstore-flyer.png[digital image] that is the promotional flyer.
